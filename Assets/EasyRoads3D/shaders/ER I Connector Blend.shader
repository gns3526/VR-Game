	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord34 = IN.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float3 unpack65 = UnpackNormalScale( tex2D( _BumpMap, texCoord41 ), _BumpScale1 );
				unpack65.z = lerp( 1, unpack65.z, saturate(_BumpScale1) );
				float2 texCoord35 = IN.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack66 = UnpackNormalScale( tex2D( _BumpMap2, texCoord35 ), _BumpScale2 );
				unpack66.z = lerp( 1, unpack66.z, saturate(_BumpScale2) );
				float3 lerpResult24 = lerp( unpack65 , unpack66 , temp_output_22_0);
				...
				float2 texCoord36 = IN.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
